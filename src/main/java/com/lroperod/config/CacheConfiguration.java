...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.lroperod.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.lroperod.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.lroperod.domain.User.class.getName());
            createCache(cm, com.lroperod.domain.Authority.class.getName());
            createCache(cm, com.lroperod.domain.User.class.getName() + ".authorities");
            createCache(cm, com.lroperod.domain.Form.class.getName());
