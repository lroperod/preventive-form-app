package com.lroperod.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.lroperod.IntegrationTest;
import com.lroperod.repository.timezone.DateTimeWrapper;
import com.lroperod.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM pfa_date_time_wrapper where id=%d", fieldName, id);
    }
